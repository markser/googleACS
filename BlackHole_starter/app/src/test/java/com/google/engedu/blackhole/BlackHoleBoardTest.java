...
public class BlackHoleBoardTest {
    ...
    public void testGetScore() {
        ...
        //************************************************************************************
        //Did not create, was pulled from https://github.com/ankitkumarojha/ACS-Android/blob/master/
        // Unit-8/BlackHole_starter/app/src/test/java/com/google/engedu/blackhole/BlackHoleBoardTest.java
        // ^^^ testing doesn't work properly LOL

        //need to go back and create my own testing
