...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onStartGame(View view) {
        ...
        // Make sure you get two different words
        int max = words.size();
        ...
        //Scrambles 2 words and sets it in messagebox
        int foo = 0;
        int bar = 0;
        ...
        while (oneL != 0 && twoL != 0) {
            ...
            if (ran == 1) {
                scrambled += word1.charAt(foo);
                oneL--;
                foo++;
            } else {
                scrambled += word2.charAt(bar);
                twoL--;
                bar++;
            }
        }
        if (oneL > 0) {
            scrambled += word1.substring(foo, word1.length());
        } else {
            scrambled += word2.substring(bar, word2.length());
        }
